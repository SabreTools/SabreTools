...
namespace SabreTools.Help.Inputs
{
    ...
    public class UInt64Input : Input<ulong?>
    {
        ...
        /// <inheritdoc/>
        public UInt64Input(string name, string[] flags, string description)
            : base(name, flags, description) { }

        /// <inheritdoc/>
        public UInt64Input(string name, string[] flags, string description, bool required)
            : base(name, flags, description, required) { }

        /// <inheritdoc/>
        public UInt64Input(string name, string[] flags, string description, string longDescription, bool required)
