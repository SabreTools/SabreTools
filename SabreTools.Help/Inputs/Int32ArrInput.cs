...
namespace SabreTools.Help.Inputs
{
    ...
    public class Int32ArrInput : Input<int?[]>
    {
        ...
        /// <inheritdoc/>
        public Int32ArrInput(string name, string[] flags, string description)
            : base(name, flags, description) { }

        /// <inheritdoc/>
        public Int32ArrInput(string name, string[] flags, string description, bool required)
            : base(name, flags, description, required) { }

        /// <inheritdoc/>
        public Int32ArrInput(string name, string[] flags, string description, string longDescription, bool required)
