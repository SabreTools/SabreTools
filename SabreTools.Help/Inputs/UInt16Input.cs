...
namespace SabreTools.Help.Inputs
{
    ...
    public class UInt16Input : Input<ushort?>
    {
        ...
        /// <inheritdoc/>
        public UInt16Input(string name, string[] flags, string description)
            : base(name, flags, description) { }

        /// <inheritdoc/>
        public UInt16Input(string name, string[] flags, string description, bool required)
            : base(name, flags, description, required) { }

        /// <inheritdoc/>
        public UInt16Input(string name, string[] flags, string description, string longDescription, bool required)
