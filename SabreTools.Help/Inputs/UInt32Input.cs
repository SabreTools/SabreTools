...
namespace SabreTools.Help.Inputs
{
    ...
    public class UInt32Input : Input<uint?>
    {
        ...
        /// <inheritdoc/>
        public UInt32Input(string name, string[] flags, string description)
            : base(name, flags, description) { }

        /// <inheritdoc/>
        public UInt32Input(string name, string[] flags, string description, bool required)
            : base(name, flags, description, required) { }

        /// <inheritdoc/>
        public UInt32Input(string name, string[] flags, string description, string longDescription, bool required)
