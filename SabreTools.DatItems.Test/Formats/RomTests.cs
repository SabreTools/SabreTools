...
namespace SabreTools.DatItems.Test.Formats
{
    public class RomTests
    {
        ...
        public void FillMissingInformation_BothEmpty()
        {
            ...
            Assert.Null(self.GetStringFieldValue(Models.Metadata.Rom.RIPEMD128Key));
            Assert.Null(self.GetStringFieldValue(Models.Metadata.Rom.RIPEMD160Key));
        ...
        public void FillMissingInformation_AllMissing()
        {
            ...
            other.SetFieldValue(Models.Metadata.Rom.RIPEMD128Key, "XXXXXX");
            other.SetFieldValue(Models.Metadata.Rom.RIPEMD160Key, "XXXXXX");
            ...
            Assert.Equal("XXXXXX", self.GetStringFieldValue(Models.Metadata.Rom.RIPEMD128Key));
            Assert.Equal("XXXXXX", self.GetStringFieldValue(Models.Metadata.Rom.RIPEMD160Key));
        ...
        public void HasHashes_CRC_True()
        {
            ...
            self.SetFieldValue(Models.Metadata.Rom.RIPEMD128Key, string.Empty);
            self.SetFieldValue(Models.Metadata.Rom.RIPEMD160Key, string.Empty);
        ...
        public void HasHashes_RIPEMD128_True()
        {
            ...
            self.SetFieldValue(Models.Metadata.Rom.MD4Key, string.Empty);
            self.SetFieldValue(Models.Metadata.Rom.MD5Key, string.Empty);
            self.SetFieldValue(Models.Metadata.Rom.RIPEMD128Key, "XXXXXX");
            self.SetFieldValue(Models.Metadata.Rom.RIPEMD160Key, string.Empty);
            self.SetFieldValue(Models.Metadata.Rom.SHA1Key, string.Empty);
            self.SetFieldValue(Models.Metadata.Rom.SHA256Key, string.Empty);
            self.SetFieldValue(Models.Metadata.Rom.SHA384Key, string.Empty);
        ...
        public void HasHashes_RIPEMD160_True()
        {
            ...
            self.SetFieldValue(Models.Metadata.Rom.MD5Key, string.Empty);
            self.SetFieldValue(Models.Metadata.Rom.RIPEMD128Key, string.Empty);
            self.SetFieldValue(Models.Metadata.Rom.RIPEMD160Key, "XXXXXX");
            self.SetFieldValue(Models.Metadata.Rom.SHA1Key, string.Empty);
            self.SetFieldValue(Models.Metadata.Rom.SHA256Key, string.Empty);
            self.SetFieldValue(Models.Metadata.Rom.SHA384Key, string.Empty);
            self.SetFieldValue(Models.Metadata.Rom.SHA512Key, string.Empty);
        ...
        public void HasZeroHash_ZeroRIPEMD128_True()
        {
            ...
            self.SetFieldValue(Models.Metadata.Rom.MD4Key, string.Empty);
            self.SetFieldValue(Models.Metadata.Rom.MD5Key, string.Empty);
            self.SetFieldValue(Models.Metadata.Rom.RIPEMD128Key, ZeroHash.GetString(HashType.RIPEMD128));
            self.SetFieldValue(Models.Metadata.Rom.RIPEMD160Key, string.Empty);
            self.SetFieldValue(Models.Metadata.Rom.SHA1Key, string.Empty);
            self.SetFieldValue(Models.Metadata.Rom.SHA256Key, string.Empty);
            self.SetFieldValue(Models.Metadata.Rom.SHA384Key, string.Empty);
        ...
        public void HasZeroHash_ZeroRIPEMD160_True()
        {
            ...
            self.SetFieldValue(Models.Metadata.Rom.MD5Key, string.Empty);
            self.SetFieldValue(Models.Metadata.Rom.RIPEMD128Key, string.Empty);
            self.SetFieldValue(Models.Metadata.Rom.RIPEMD160Key, ZeroHash.GetString(HashType.RIPEMD160));
            self.SetFieldValue(Models.Metadata.Rom.SHA1Key, string.Empty);
            self.SetFieldValue(Models.Metadata.Rom.SHA256Key, string.Empty);
            self.SetFieldValue(Models.Metadata.Rom.SHA384Key, string.Empty);
            self.SetFieldValue(Models.Metadata.Rom.SHA512Key, string.Empty);
